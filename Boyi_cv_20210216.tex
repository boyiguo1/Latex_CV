...
\href{https://www.soph.uab.edu/bst}{Department of Biostatistics} &
Email: \href{mailto:boyiguo1@uab.edu}{boyiguo1@uab.edu}\\
\href{https://www.soph.uab.edu}{Ryals School of Public Health}	&
...
\begin{outerlist}
        ...
        \href{https://www.soph.uab.edu/bst}
             {Biostatistics}, June 2022 (Expected)
        \begin{innerlist}
...
\textbf{Guo, B.}$^\ast$, Yi, N. ``Spike-and-Slab Generalized Additive Models and Fast Algorithms for High-Dimensional Data,''Joint Statistical Meetings, Birmingham, AL. (August 8, 2021)\\
...
\textbf{Guo, B.}$^\ast$  ``Precision Medicine Research Using Statistical Learning Methods,'' Hansen and Hicks Joint Lab Meeting, Johns Hopkins University, Virtual. (August 25, 2021)\\
...
\section{Contributed Presentations \& Posters}
...
\section{Tutorials}	
\textbf{Guo, B.}, Cui, J. (2021) Automating Simulation Studies with High-performance Computation Platform \url{https://github.com/boyiguo1/Tutorial-Sim_Cluster_Composer}
