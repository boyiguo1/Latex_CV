...
\begin{outerlist}
	...
	\item[] \textit{\bf Tutorial Curator} \normalfont% 
		\begin{innerlist}
		\item Automating Simulation Studies with High-performance Computation Platform\\
		
			\textit{Joint effort with Ph.D. Student Jinhong Cui, accessible via \href{https://github.com/boyiguo1/Tutorial-Sim_Cluster_Composer}{Github}}
	\end{innerlist}		
\end{outerlist}
