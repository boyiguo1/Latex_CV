...
\textbf{Guo, B.} (2022) Calculating Residential Segregation Indices with Decennial US Census Data in an R Reproducible Workflow \url{https://github.com/boyiguo1/Tutorial-Residential_Segregation_Score}
