...
\textbf{Guo, B.}, Jaeger, B. C., Rahman, A. F., Long, D. L., Yi, Nengun, ``Spike-and-Slab Generalized Additive Models and Fast Algorithms for High-Dimensional Data" (Submitted to \textit{Statistics in Medicine})\\
